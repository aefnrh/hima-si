    ...
    <div class="max-w-md w-full bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
        <div class="px-6 py-8">
            <div class="text-center">
                <h1 class="text-9xl font-bold text-indigo-600 dark:text-indigo-500">403</h1>
                <h2 class="text-2xl font-semibold text-gray-800 dark:text-white mt-4">Akses Terlarang</h2>
                <p class="text-gray-600 dark:text-gray-400 mt-2">Maaf, Anda tidak memiliki izin untuk mengakses halaman ini.</p>
