            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('admin.kabinet.index') }}" class="px-4 py-2 bg-gray-500 text-white rounded hover:bg-gray-600">Kembali</a>
                    </div>
                ...
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex space-x-2">
                            <a href="{{ route('admin.divisions.index', ['kabinet_id' => $kabinet->id]) }}" class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600">Lihat Semua Divisi</a>
                            <a href="{{ route('admin.divisions.create', ['kabinet_id' => $kabinet->id]) }}" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Tambah Divisi</a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @forelse ($divisions as $division)
                                    <tr>
                                        ...
                                        <td class="py-2 px-4 border-b border-gray-200">
                                            <div class="flex space-x-2">
                                                <a href="{{ route('admin.divisions.edit', ['division' => $division, 'from_kabinet' => true]) }}" class="px-3 py-1 bg-yellow-500 text-white rounded hover:bg-yellow-600">Edit</a>
                                                ...
                                                <form action="{{ route('admin.divisions.destroy', ['division' => $division, 'from_kabinet' => true]) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus divisi ini?')">
                                                    @csrf
                                                    @method('DELETE')
