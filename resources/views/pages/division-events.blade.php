...
<div class="bg-gradient-to-r from-[#4A5568] to-[#667EEA] py-16">
    <div class="container mx-auto px-4">
        <div class="text-center">
            <h1 class="text-4xl font-bold text-white mb-4">Acara Divisi {{ $division->name }}</h1>
...
<div class="container mx-auto px-4 py-8">
    <div class="mb-6 flex justify-between items-center">
        ...
        <a href="{{ route('divisions.show', $division->slug) }}" class="inline-flex items-center text-blue-600 hover:text-blue-800">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <!-- Acara Divisi -->
    <div>
        <h2 class="text-2xl font-bold text-gray-800 mb-6 pb-2 border-b-2 border-[#667EEA]">Acara Divisi {{ $division->name }}</h2>
        ...
        <div class="mt-8 text-center">
            <a href="{{ route('events.division.all', $division->slug) }}" class="inline-flex items-center justify-center bg-[#667EEA] text-white px-6 py-3 rounded-lg hover:bg-[#5A67D8] transition duration-300">
                <span>Lihat Semua Acara Divisi {{ $division->name }}</span>
