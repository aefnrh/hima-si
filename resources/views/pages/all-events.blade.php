...
<div class="bg-gradient-to-r from-[#4A5568] to-[#667EEA] py-16">
    <div class="container mx-auto px-4">
        <div class="text-center">
            <h1 class="text-4xl font-bold text-white mb-4">Semua Acara Sebelumnya</h1>
            <p class="text-xl text-blue-100">Arsip kegiatan dan acara yang telah diselenggarakan oleh Himpunan Mahasiswa Sistem Informasi.</p>
        </div>
    </div>
</div>
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        ...
        <div class="flex flex-wrap gap-2">
            <a href="{{ route('events.all') }}" class="px-4 py-2 bg-blue-600 text-white rounded-full text-sm hover:bg-blue-700 transition duration-300">
                Semua Acara
            </a>
    ...
    <!-- Semua Acara Sebelumnya -->
    <div>
        <h2 class="text-2xl font-bold text-gray-800 mb-6 pb-2 border-b-2 border-[#667EEA]">Arsip Acara</h2>
