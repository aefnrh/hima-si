        ...
        <footer class="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white pt-16 pb-8 relative overflow-hidden">
            ...
            <div class="container mx-auto px-4 relative z-10"></div>
                ...
                <div class="flex flex-col md:flex-row justify-between mb-12 gap-8">
                    <div class="mb-8 md:mb-0 md:w-1/3 transform hover:scale-105 transition duration-300">
                        <div class="flex items-center mb-4 bg-gray-800 bg-opacity-50 p-4 rounded-lg shadow-xl">
                            <img src="{{ asset('images/LOGO HIMA/LOGO HIMA SI BARU.png') }}" alt="Logo HIMA SI UNIKU" class="h-8 mr-2 filter drop-shadow-lg">
                            <img src="{{ asset('images/LOGO HIMA/Logo Text Putih.png') }}" alt="Logo HIMA SI UNIKU" class="h-14 mr-2 filter drop-shadow-lg">
                        </div>
                        <p class="text-gray-300 mb-6 max-w-md leading-relaxed backdrop-blur-sm bg-gray-800 bg-opacity-30 p-4 rounded-lg">
                        ...
                        <div class="flex space-x-4">
                            <a href="{{ $settings['tiktok'] ?? 'https://www.tiktok.com/@himasi_uniku' }}" target="_blank" class="bg-gradient-to-r from-gray-800 to-gray-700 hover:from-[#667EEA] hover:to-[#764BA2] text-white p-3 rounded-full transition duration-500 transform hover:scale-110 hover:rotate-12 shadow-lg">
                            ...
                            <a href="{{ $settings['youtube'] ?? 'http://youtube.com/@HIMASIFKOM-UNIKU' }}" target="_blank" class="bg-gradient-to-r from-gray-800 to-gray-700 hover:from-red-600 hover:to-red-700 text-white p-3 rounded-full transition duration-500 transform hover:scale-110 hover:rotate-12 shadow-lg">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"/>
                                </svg>
                            </a>
                            <a href="{{ $settings['whatsapp'] ?? 'https://wa.me/6281322285522' }}" target="_blank" class="bg-gradient-to-r from-gray-800 to-gray-700 hover:from-green-500 hover:to-green-600 text-white p-3 rounded-full transition duration-500 transform hover:scale-110 hover:rotate-12 shadow-lg">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.893 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.884-.001 2.225.651 3.891 1.746 5.634l-.999 3.648 3.742-.981zm11.387-5.464c-.074-.124-.272-.198-.57-.347-.297-.149-1.758-.868-2.031-.967-.272-.099-.47-.149-.669.149-.198.297-.768.967-.941 1.165-.173.198-.347.223-.644.074-.297-.149-1.255-.462-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.297-.347.446-.521.151-.172.2-.296.3-.495.099-.198.05-.372-.025-.521-.075-.148-.669-1.611-.916-2.206-.242-.579-.487-.501-.669-.51l-.57-.01c-.198 0-.52.074-.792.372s-1.04 1.016-1.04 2.479 1.065 2.876 1.213 3.074c.149.198 2.095 3.2 5.076 4.487.709.306
                                </svg> 1.263.489 1.694.626.712.226 1.36.194 1.872.118.571-.085 1.758-.719 2.006-1.413.248-.695.248-1.29.173-1.414z"/>
                            </a>
                            <a href="{{ $settings['instagram'] ?? 'https://www.instagram.com/himasi_uniku?' }}" target="_blank" class="bg-gradient-to-r from-gray-800 to-gray-700 hover:from-purple-500 hover:to-pink-500 text-white p-3 rounded-full transition duration-500 transform hover:scale-110 hover:rotate-12 shadow-lg">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                </svg>m6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:w-2/3">
                        <!-- Quick Links -->
                        <div class="backdrop-blur-sm bg-gray-800 bg-opacity-30 p-6 rounded-xl transform hover:scale-105 transition duration-300">
                            ...
                            <ul class="space-y-3">
                                @php
                                $links = [
                                    ['path' => '/', 'label' => 'Beranda', 'type' => 'url'],
                                    ['path' => '/about', 'label' => 'Tentang Kami', 'type' => 'url'],
                                    ['path' => 'events.index', 'label' => 'Acara', 'type' => 'route'],
                                    ['path' => 'aspirations.index', 'label' => 'Aspirasi', 'type' => 'route'],
                                    ['path' => 'contact.index', 'label' => 'Kontak', 'type' => 'route']
                                ];
                                @endphp
                                @foreach($links as $link)
                                    <li>
                                        <a href="{{ $link['type'] === 'url' ? url($link['path']) : route($link['path']) }}" 
                                           class="group text-gray-300 hover:text-white transition duration-300 flex items-center">
                        ...
                        <div class="backdrop-blur-sm bg-gray-800 bg-opacity-30 p-6 rounded-xl transform hover:scale-105 transition duration-300">
                            ...
                            <ul class="space-y-4">
                                <li class="group flex items-start transform hover:translate-x-2 transition-transform duration-300">
                                    <span class="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-[#667EEA] to-[#764BA2] rounded-full flex items-center justify-center shadow-lg">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                                        </svg>
                                    </span>
                                    <span class="ml-3 text-gray-300">{{ $settings['address'] ?? 'Jl. Pramuka No.67, Purwawinangun, Kec. Kuningan, Kabupaten Kuningan, Jawa Barat 45512' }}</span>
                                </li>
                                <li class="group flex items-center transform hover:translate-x-2 transition-transform duration-300">
                                    <span class="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-[#667EEA] to-[#764BA2] rounded-full flex items-center justify-center shadow-lg">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                        </svg>
                                    </span>
                                    <span class="ml-3 text-gray-300">{{ $settings['email'] ?? 'himas.si.fkom@uniku.ac.id' }}</span>
                                </li>
                                <li class="group flex items-center transform hover:translate-x-2 transition-transform duration-300">
                                    <span class="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-[#FF750F] to-[#F7B733] rounded-full flex items-center justify-center shadow-lg">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                        </svg>
                                    </span>
                                    <span class="ml-3 text-gray-300">{{ $settings['phone'] ?? '+62 811 2233 4455' }}</span>
                                </li>
                            </ul>
                        </div>
                        <!-- Newsletter -->
                        <div class="backdrop-blur-sm bg-gray-800 bg-opacity-30 p-6 rounded-xl transform hover:scale-105 transition duration-300">
                            ...
                            <p class="text-gray-300 mb-6">Dapatkan informasi terbaru dari kami.</p>
                            <form action="{{ route('newsletter.subscribe') }}" method="POST" class="space-y-3">
                                @csrf
                                <div>
                                    <input type="text" name="name" placeholder="Nama Anda" 
                                           class="w-full bg-gray-700 bg-opacity-50 text-white px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF750F] transition duration-300 backdrop-blur-sm mb-3">
                                </div>
                                <div class="relative">
                                    <input type="email" name="email" placeholder="Email Anda" 
                                           class="w-full bg-gray-700 bg-opacity-50 text-white px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF750F] transition duration-300 backdrop-blur-sm">
                                    <button type="submit" 
                                            class="absolute right-2 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-[#667EEA] to-[#764BA2] text-white p-2 rounded-lg hover:from-[#764BA2] hover:to-[#667EEA] transition duration-300">
                ...
                <div class="pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
                    <p class="text-gray-400 mb-4 md:mb-0">&copy; {{ date('Y') }} HIMA SI UNIKU. All rights reserved.</p>
                </div>
            </div>
        </footer>
    </div>
